...
:::callout-note
if the images aren't visible, an html version of how the webpage looks on my pc can be found in /content/03_other/"Automated machine Learning with H20(1).html". The figures can be viewed separately in \content\01_journal\03_data_wrangling_files\figure-html.
:::
